...
public class RegisterController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        String leaveBalanceStr = request.getParameter("leaveBalance");
	        int leaveBalance = 0;
	        if (leaveBalanceStr != null && !leaveBalanceStr.trim().isEmpty()) {
	            leaveBalance = Integer.parseInt(leaveBalanceStr);
	        }
